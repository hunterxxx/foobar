const context = {
    items: [
        { name: "Priyank Chopra's Wedding", place: "Mumbai, India",
         date: "15.09.2018", src: "components/img/weddingevent.PNG", description: "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt magna aliquyam erat, sed diam voluptua." },
